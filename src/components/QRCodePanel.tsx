...
const QRCodePanel: React.FC<QRCodePanelProps> = ({ isActive = false }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('openQRStylePanel', handleOpenStylePanel);
    
    return () => {
      window.removeEventListener('openQRStylePanel', handleOpenStylePanel);
    };
  }, []);
  ...
  const handleAddQRCode = () => {
    if (isValidUrl && url) {
      ...
      console.log('Real QR Code added to canvas:', finalUrl, qrOptions);
    }
  };
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 h-full overflow-y-auto">
      ...
      {isValidUrl && url && (
        <div className="mb-8">
          <h3 className="text-sm font-medium text-gray-900 mb-4">QR Code Options</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                <option value="small">Small (100×100px)</option>
                <option value="medium">Medium (150×150px)</option>
                <option value="large">Large (200×200px)</option>
              </select>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <span className="text-sm text-gray-600 font-mono">{foregroundColor}</span>
                </div>
              </div>
              <div>
