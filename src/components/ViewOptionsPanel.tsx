...
const ViewOptionsPanel: React.FC<ViewOptionsPanelProps> = ({
  ...
  return (
    <>
      ...
      <div 
        ref={panelRef}
        className="absolute top-full right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 w-80 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200"
      >
        {/* Header */}
        ...
        <div className="border-t border-gray-100 p-6">
          <button className="flex items-center space-x-3 text-gray-700 hover:text-gray-900 transition-colors group">
            <Monitor className="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors" />
